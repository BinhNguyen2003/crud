  ...
  <tbody>
    ...
    <tr>
      ...
      <td class="text-right">
        ...
        <a href="{{route('user.viewUser',['id' => $user->id ])}}" class="btn btn-sm  btn-success"><i class="fas fa show">show</a>
        <form action="{{ route('user.delete', ['id'=>$user->id])}}" method="post">
          @csrf
          @method('DELETE')
          <br>
          <button type="submit" class="btn btn-sm btn-success"><i class="fas fa edit">Xóa</i></button>
        </form>
      </td>
    </tr>
    @endforeach
